...
function buildDetailResponse({ eventId, storm, tracks, now, gdacsStatus = 'ok', zhejiangStatus = 'ok' }) {
  ...
  return {
    schemaVersion: '2', status: tracks.observed.length ? 'ok' : 'degraded', generatedAt: now.toISOString(),
    storm,
    ...
    mapConfig: {
      ...
      weatherLayers: [
        { id: 'radar', label: '天气雷达', provider: 'RainViewer', type: 'rainviewer', defaultVisible: true },
        { id: 'himawari-ir', label: '红外云图', provider: 'NASA GIBS', type: 'wms', layer: 'Himawari_AHI_Band13_Clean_Infrared', defaultVisible: false },
        { id: 'himawari-visible', label: '可见光云图', provider: 'NASA GIBS', type: 'wms', layer: 'Himawari_AHI_Band3_Red_Visible_1km', defaultVisible: false },
        { id: 'precipitation', label: '降水估算', provider: 'NASA GIBS', type: 'wms', layer: 'IMERG_Precipitation_Rate', defaultVisible: false }
      ]
    },
    sourceHealth: [
